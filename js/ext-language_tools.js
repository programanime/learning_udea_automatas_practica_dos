...
var AcePopup = function(parentNode) {
    ...
    bgTokenizer.$tokenizeRow = function(row) {
        ...
        // tokens[tokens.length-1].type=tokens[tokens.length-1].type+" lomio";
        if(data.tipo){
            tokens.push({type: "completador_"+data.tipo, value: data.tipo});
        }else{
            tokens.push({type: "completador_snippet", value: "snippet"});
        }
...
(function() {
    ...
    this.insertMatch = function(data, options) {
        ...
        if (!data)
            return false;
        // if (data.completer && data.completer.insertMatch)data.completer.insertMatch(this.editor, data);
